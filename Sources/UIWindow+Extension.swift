...
public extension UIWindow {
     ...
     */
    public func eln_replaceRootViewController(with viewController: UIViewController, animation: RootViewControllerTransitionAnimation, completion: @escaping (Bool) -> Void) {
        ...
        let completion_: (Bool) -> Void = { finished in
            ...
            if rootViewController.presentedViewController != nil {
                self.eln_dismissPresentedViewControllers(for: rootViewController, completion: {
    ...
    private func eln_dismissPresentedViewControllers(for viewController: UIViewController, completion: (() -> ())? = nil) {
        ...
        viewController.dismiss(animated: false) { [weak self, weak viewController] in
            ...
            self?.eln_dismissPresentedViewControllers(for: viewController, completion: completion)
        }
    }
